...
feature_row_booking:
  - icon: "fa-solid fa-calendar-check"
    title: "48-Hour Advance Booking"
    excerpt: "All classes require at least 48 hours notice to prepare materials and reserve studio time."
  - icon: "fa-solid fa-credit-card"
    title: "50% Deposit to Secure"
    excerpt: "Pay via secure link with Visa, Mastercard, or Amex. Balance due on the day of class."
...
I've been working with clay for **10 years**, and I still feel there's so much to learn. Ceramics teaches calm, observation, patience, and a deep connection with your body and the material. My goal is to share not just technique, but that connection.
...
{% include notice type="info" icon="fa-solid fa-clock" content="**Booking requires 48 hours advance notice.** A 50% deposit (Visa / Mastercard / Amex) secures your spot. After booking you'll receive the studio address and safe transportation options." %}
...
{% include feature_row id="feature_row_booking" type="center" %}
